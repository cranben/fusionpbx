...
$text['title-notifications']['ro-ro'] = "Сповіщення";
...
$text['option-enabled']['ro-ro'] = "Увімкнено";
...
$text['option-email']['ro-ro'] = "Електронна пошта";
...
$text['option-disabled']['ro-ro'] = "Вимкнено";
...
$text['message-no_channels']['ro-ro'] = "Немає ввімкнених каналів";
...
$text['message-invalid_recipient']['ro-ro'] = "Недійсний одержувач сповіщення";
...
$text['message-demographics_submitted']['ro-ro'] = "Демографічні дані подано";
...
$text['message-demographics_click_here']['ro-ro'] = "натисніть тут";
...
$text['message-demographics']['ro-ro'] = "<u>Примітка</u>: щоб допомогти проекту FusionPBX, надавши описану вище демографічну інформацію <i>без</i> підписки на сповіщення про проект, просто";
...
$text['label-project_security']['ro-ro'] = "Безпека";
...
$text['label-project_releases']['ro-ro'] = "Релізи";
...
$text['label-project_notifications']['ro-ro'] = "Повідомлення про проект";
...
$text['label-project_notification_recipient']['ro-ro'] = "одержувач";
...
$text['label-project_notification_method']['ro-ro'] = "метод";
...
$text['label-project_news']['ro-ro'] = "Новини";
...
$text['label-project_events']['ro-ro'] = "Події";
...
$text['header-notifications']['ro-ro'] = "Сповіщення";
...
$text['description-project_security']['ro-ro'] = "Отримувати сповіщення про оновлення безпеки.";
...
$text['description-project_releases']['ro-ro'] = "Отримуйте сповіщення, коли нова стабільна версія FusionPBX буде випущена та доступна для завантаження.";
...
$text['description-project_notifications']['ro-ro'] = "Увімкнути сповіщення про проект FusionPBX.";
...
$text['description-project_notification_recipient']['ro-ro'] = "Введіть бажану адресу електронної пошти одержувача.";
...
$text['description-project_notification_method']['ro-ro'] = "Виберіть потрібний спосіб спілкування.";
...
$text['description-project_news']['ro-ro'] = "Отримуйте сповіщення про загальні новини та інформацію щодо FusionPBX.";
...
$text['description-project_events']['ro-ro'] = "Отримуйте сповіщення про майбутні навчальні курси FusionPBX, стенди для конференцій та інші події, пов’язані з проектом.";
...
$text['description-notifications']['ro-ro'] = "Встановіть параметри сповіщень для зв’язку, пов’язаного з проектом FusionPBX, та інших сповіщень локальної системи.";
